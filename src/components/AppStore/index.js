...
class AppStore extends Component {
  ...
  getActiveApps = searchedApps => {
    const {activeTabId} = this.setState
  ...
  getSearchedResults = () => {
    ...
    const searchedResults = appsList.filter(eachItem =>
  ...
  render() {
    ...
    const searchResults = this.getSearchedResults()
